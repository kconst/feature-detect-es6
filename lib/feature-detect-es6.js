...
exports.destructuringDeepMatching = function () {
  return evaluates('var { op: a, lhs: { op: b }, rhs: c } = (function(){ return { op: 1, lhs: { op: 2 }, rhs: 3 }; }());');
};

exports.destructuringMatchingDefaultValues = function () {
  return evaluates('var obj = { a: 1 }; var list = [ 1 ]; var { a, b = 2 } = obj; var [ x, y = 2 ] = list');
};

exports.objectAssign = function () {
    return evaluates('Object.assign({}, { test: 1 });');
};

exports.objectShorthand = function () {
    return evaluates('var obj = { x, y };');
};

exports.computedPropertyNames = function () {
    return evaluates('var obj = { foo: "bar", [ "baz" + function(){ return 0; } ]: 42 };');
};

exports.enhancedObjectProperties = function () {
    return evaluates('var obj = {foo (a, b) {},bar (x, y) {},*quux (x, y) {}}');
};
